...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='fpinstitute',
            name='registration',
            field=models.ForeignKey(blank=True, default='', on_delete=django.db.models.deletion.CASCADE, related_name='institutes', to='fpraktikum.FpRegistration', verbose_name='registration'),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='fpinstitute',
            name='semester_half',
            field=models.IntegerField(blank=True, choices=[(1, '1.'), (2, '2.'), (3, 'both')], verbose_name='semester half'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='registrant',
            field=models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='partner', to='fpraktikum.FpUserRegistrant', verbose_name='registrant'),
        ),
        migrations.AlterField(
            model_name='fpuserpartner',
            name='user_email',
