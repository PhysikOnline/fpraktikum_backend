    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('graduation', models.CharField(choices=[('BA', 'Bachelor'), ('MA', 'Master'), ('L', 'Lehramt')], max_length=2)),
            ],
            options={
                'verbose_name': 'course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateTimeField(auto_now_add=True, null=True, verbose_name='startdate of registration')),
        ...
        migrations.AddField(
            model_name='course',
            name='semester_half',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='fpraktikum.FpRegistration', verbose_name='semester half'),
        ),
    ]
