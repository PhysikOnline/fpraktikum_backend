...
class FpUserPartnerAdmin(admin.ModelAdmin):
    list_display = ("user_firstname", "user_lastname", "has_accepted", "user_email", "user_snumber", "get_institutes", "registrant")
...
class FpUserRegistrantAdmin(admin.ModelAdmin):
    ...
    list_display = ("user_firstname", "user_lastname", "partner_has_accepted", "user_email", "user_snumber", "get_institutes", "partner")
